...
function BlogPages({ page, posts, pageNo }) {
    return (
...
export async function getStaticPaths() {
  ...
  const paginatedPosts = await filer.getPaginatedItems('posts', { excerpt: true, sortKey: 'date', pagination: {size: page.data?.pagination?.size || 9} });
